...
export const metadata: Metadata = {
  title: 'Wind Damage Roof Repair Treasure Valley | Storm Repair | Boise Roof Repair Pros | Boise Roof Repair Pros',
  description: 'Expert wind damage roof repair for all types of wind-related roofing damage. Serving Boise, Meridian, Nampa & the Treasure Valley. 24/7 emergency service available. Call (208) 505-9352.',
  alternates: {
    canonical: 'https://boise-roof-repair.com/services/storm-damage/wind-damage-repair',
  },
}

const commonProblems = ['Missing shingles', 'Lifted shingles', 'Torn shingles', 'Damaged flashing', 'Exposed decking']

export default function WindDamageRepairPage() {
  return (
    <main className="pt-20">
      <section className="relative py-24 md:py-32">
        <Image
          src="/generated/wind-damage-repair.webp"
          alt="Wind Damage Roof Repair in Treasure Valley"
          fill
          priority
        ...
        <div className="relative z-10 container mx-auto px-4 text-center">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6">Wind Damage Roof Repair</h1>
          <p className="text-xl text-gray-200 max-w-3xl mx-auto mb-8">Expert wind damage roof repair for all types of wind-related roofing damage.</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold text-dark-blue mb-6">Professional Wind Damage Roof Repair in the Treasure Valley</h2>
            <div className="prose prose-lg max-w-none text-gray-600">
              <p>Expert wind damage roof repair for all types of wind-related roofing damage. Our experienced technicians are equipped to handle all your storm damage needs, from minor repairs to complete system replacements.</p>
              <p>We serve homeowners throughout Boise, Meridian, Nampa, Caldwell, Eagle, and surrounding communities. When you need wind damage repair, you can count on Boise Roof Repair Pros for fast, professional service.</p>
            </div>
            ...
            <div className="mt-12 p-8 bg-dark-blue rounded-xl text-center">
              <h3 className="text-2xl font-bold text-white mb-4">Need Wind Damage Roof Repair?</h3>
