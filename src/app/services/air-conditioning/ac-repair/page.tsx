...
export const metadata: Metadata = {
  title: 'AC Repair Treasure Valley | Air Conditioning Repair | Boise HVAC Pros | Boise HVAC Pros',
  description: 'Fast, reliable air conditioning repair services. We fix all AC brands and models. Serving Boise, Meridian, Nampa & the Treasure Valley. 24/7 emergency service available. Call (208) 505-9352.',
  alternates: {
    canonical: 'https://hvac-boise.com/services/air-conditioning/ac-repair',
  },
}

const commonProblems = ['AC not cooling', 'AC blowing warm air', 'AC making strange noises', 'AC not turning on', 'High energy bills', 'Uneven cooling', 'Refrigerant leaks', 'Frozen evaporator coil']
    ...
    <main className="pt-20">
      <section className="relative py-24 md:py-32">
        <Image
          ...
          alt="AC Repair in Treasure Valley"
          fill
          priority
        ...
        <div className="relative z-10 container mx-auto px-4 text-center">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6">AC Repair</h1>
          <p className="text-xl text-gray-200 max-w-3xl mx-auto mb-8">Fast, reliable air conditioning repair services. We fix all AC brands and models.</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold text-dark-blue mb-6">Professional AC Repair in the Treasure Valley</h2>
            <div className="prose prose-lg max-w-none text-gray-600">
              <p>Fast, reliable air conditioning repair services. We fix all AC brands and models. Our experienced technicians are equipped to handle all your ac needs, from minor repairs to complete system replacements.</p>
              <p>We serve homeowners throughout Boise, Meridian, Nampa, Caldwell, Eagle, and surrounding communities. When you need ac repair, you can count on Boise HVAC Pros for fast, professional service.</p>
            </div>
            ...
            <div className="mt-12 p-8 bg-dark-blue rounded-xl text-center">
              <h3 className="text-2xl font-bold text-white mb-4">Need AC Repair?</h3>
