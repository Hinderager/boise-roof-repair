...
export const metadata: Metadata = {
  title: 'Chimney Leak Repair Treasure Valley | Chimney Flashing | Boise Roof Repair Pros | Boise Roof Repair Pros',
  description: 'Expert chimney leak repair and flashing replacement to stop water intrusion. Serving Boise, Meridian, Nampa & the Treasure Valley. Call (208) 505-9352.',
  alternates: {
    canonical: 'https://boise-roof-repair.com/services/leak-repair/chimney-leak-repair',
  },
}
  ...
  return (
    <main className="pt-20">
      <section className="relative py-24 md:py-32">
        <Image
          src="/generated/chimney-leak-repair.webp"
          alt="Chimney Leak Repair & Flashing in Treasure Valley"
          fill
          priority
        ...
        <div className="relative z-10 container mx-auto px-4 text-center">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6">Chimney Leak Repair & Flashing</h1>
          <p className="text-xl text-gray-200 max-w-3xl mx-auto mb-8">Expert chimney leak repair and flashing replacement to stop water intrusion.</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold text-dark-blue mb-6">Professional Chimney Leak Repair & Flashing in the Treasure Valley</h2>
            <div className="prose prose-lg max-w-none text-gray-600">
              <p>Expert chimney leak repair and flashing replacement to stop water intrusion. Our experienced technicians are equipped to handle all your leak repair needs, from minor repairs to complete system replacements.</p>
              <p>We serve homeowners throughout Boise, Meridian, Nampa, Caldwell, Eagle, and surrounding communities. When you need chimney leak repair, you can count on Boise Roof Repair Pros for fast, professional service.</p>
            </div>
            ...
            <div className="mt-12 p-8 bg-dark-blue rounded-xl text-center">
              <h3 className="text-2xl font-bold text-white mb-4">Need Chimney Leak Repair & Flashing?</h3>
