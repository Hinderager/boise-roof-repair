...
export const metadata: Metadata = {
  title: 'Emergency Roof Leak Repair Treasure Valley | 24/7 Service | Boise Roof Repair Pros | Boise Roof Repair Pros',
  description: '24/7 emergency roof leak repair when you need it most. Fast response to stop water damage. Serving Boise, Meridian, Nampa & the Treasure Valley. 24/7 emergency service available. Call (208) 505-9352.',
  alternates: {
    canonical: 'https://boise-roof-repair.com/services/leak-repair/emergency-leak-repair',
  },
}

const commonProblems = ['Active roof leaks', 'Water stains on ceiling', 'Dripping water inside', 'Storm damage leaks', 'Ice dam leaks']

export default function EmergencyLeakRepairPage() {
  return (
    <main className="pt-20">
      <section className="relative py-24 md:py-32">
        <Image
          src="/generated/emergency-leak-repair.webp"
          alt="Emergency Roof Leak Repair in Treasure Valley"
          fill
          priority
        ...
        <div className="relative z-10 container mx-auto px-4 text-center">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6">Emergency Roof Leak Repair</h1>
          <p className="text-xl text-gray-200 max-w-3xl mx-auto mb-8">24/7 emergency roof leak repair when you need it most. Fast response to stop water damage.</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold text-dark-blue mb-6">Professional Emergency Roof Leak Repair in the Treasure Valley</h2>
            <div className="prose prose-lg max-w-none text-gray-600">
              <p>24/7 emergency roof leak repair when you need it most. Fast response to stop water damage. Our experienced technicians are equipped to handle all your leak repair needs, from minor repairs to complete system replacements.</p>
              <p>We serve homeowners throughout Boise, Meridian, Nampa, Caldwell, Eagle, and surrounding communities. When you need emergency leak repair, you can count on Boise Roof Repair Pros for fast, professional service.</p>
            </div>
            ...
            <div className="mt-12 p-8 bg-dark-blue rounded-xl text-center">
              <h3 className="text-2xl font-bold text-white mb-4">Need Emergency Roof Leak Repair?</h3>
