...
export const metadata: Metadata = {
  title: '24/7 Emergency Roof Repair Treasure Valley | Immediate Service | Boise Roof Repair Pros | Boise Roof Repair Pros',
  description: 'Round-the-clock emergency roof repair service. We are here when you need us most. Serving Boise, Meridian, Nampa & the Treasure Valley. 24/7 emergency service available. Call (208) 505-9352.',
  alternates: {
    canonical: 'https://boise-roof-repair.com/services/emergency-repair/24-7-service',
  },
}



export default function TwentyFourSevenEmergencyServicePage() {
  return (
    <main className="pt-20">
      <section className="relative py-24 md:py-32">
        <Image
          src="/generated/24-7-service.webp"
          alt="24/7 Emergency Roof Repair in Treasure Valley"
          fill
          priority
        ...
        <div className="relative z-10 container mx-auto px-4 text-center">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6">24/7 Emergency Roof Repair</h1>
          <p className="text-xl text-gray-200 max-w-3xl mx-auto mb-8">Round-the-clock emergency roof repair service. We are here when you need us most.</p>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold text-dark-blue mb-6">Professional 24/7 Emergency Roof Repair in the Treasure Valley</h2>
            <div className="prose prose-lg max-w-none text-gray-600">
              <p>Round-the-clock emergency roof repair service. We are here when you need us most. Our experienced technicians are equipped to handle all your emergency needs, from minor repairs to complete system replacements.</p>
              <p>We serve homeowners throughout Boise, Meridian, Nampa, Caldwell, Eagle, and surrounding communities. When you need 24/7 emergency service, you can count on Boise Roof Repair Pros for fast, professional service.</p>
            </div>
            ...
            <div className="mt-12 p-8 bg-dark-blue rounded-xl text-center">
              <h3 className="text-2xl font-bold text-white mb-4">Need 24/7 Emergency Roof Repair?</h3>
